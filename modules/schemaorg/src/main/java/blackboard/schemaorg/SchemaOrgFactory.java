    ...
    public static MedicalCondition createSampleMedicalCondition ()
        ...
        MedicalCondition object =
            ...
            .addRecognizingAuthority(
                         ...
                         .addDescription("Support Organization")
            ...
            .addRecognizingAuthority
            (CoreFactory.newOrganizationBuilder()
             .addName("Patient Access Network Foundation")
             .addDescription("Financial Assistance Organization")
             .addUrl("https://panfoundation.org/index.php/en/patients/assistance-programs/gaucher-disease"))
